        ...
        overloads: [
            {
                parameters: [
                    {
                        ...
                        name: 'value',
                        templateType: ['scalar'],
                        componentType: ['float', 'int'], // numeric
                        size: 'any',
                        description: 'The first vector.',
                    },
                ],
                returnType: {
                    templateType: 'scalar',
                    componentType: 'same', // ['float', 'int', 'uint'],
                    size: 'same',
                },
            },
        ],
                ...
                parameters: [
                    {
                        ...
                        componentType: ['float', 'int'], // numeric
                        size: 'any',
                        description: 'The multiplication value.',
                    },
                    {
                        modifiers: 'in',
                        name: 'avalue',
                        ...
                        componentType: ['float', 'int'], // numeric
                        size: 'same',
                        description: 'The first addition value.',
                    },
                    {
                        modifiers: 'in',
                        name: 'bvalue',
                        ...
                        componentType: ['float', 'int'], // numeric
                        size: 'same',
                        description: 'The second addition value.',
                    },
                ],
                returnType: {
                    templateType: 'same',
        ...
        overloads: [
            {
                ...
                returnType: {
                    templateType: 'same',
                    componentType: 'same', //['float', 'double'],
                    size: 'same',
                },
            },
        ],
        ...
        overloads: [
            {
                ...
                returnType: {
                    templateType: 'matrix',
                    componentType: 'same', //['float', 'int', 'bool'],
                    size: 'same', // TODO: same vs any
                },
            },
        ],
